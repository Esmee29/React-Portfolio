  ...
  return (
    <div className="bg-blue-600 text-white min-h-screen p-6">
      <div className="flex flex-col items-center mb-12">
        <h1 className="text-4xl font-bold mb-6">JavaScript Array</h1>
        <img src={jsArrayImage} alt="JavaScript Array" className="w-full max-w-4xl h-auto rounded-md shadow-lg" />
      </div>
